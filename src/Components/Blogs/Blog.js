...
const Blog = () => {
    return (
        <div className='container'>
            <div>
            <h1 className='text-3xl'>1.What is the purpose of react-router?</h1>
            ...
            <div>
            <h1 className='text-3xl'>2.How to use Context API?</h1>
            ...
            <div>
            <h1 className='text-3xl'>3.How Use Refs to hooks?</h1>
